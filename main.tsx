...
function HomeTab({isCreator}:{isCreator:boolean}){return <>
  <section className="homeTop"><div className="homeTopText"><span className="eyebrow">dashboard</span><h2>Центр найма</h2><p>Подключи HH.ru и получи рейтинг кандидатов за минуты.</p></div><div className="miniPreview"><div className="candidateMini good"><span>87</span><b>Мария</b><small>сильный опыт</small></div><div className="candidateMini mid"><span>72</span><b>Иван</b><small>есть риски</small></div><div className="candidateMini low"><span>54</span><b>Анна</b><small>нужны вопросы</small></div></div></section>
